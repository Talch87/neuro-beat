...
NeuroBeat is available under **AGPL-3.0** for open research and reproducible use (see
[`LICENSE`](LICENSE)). A **commercial license** is available for organizations that want to
integrate, modify, or deploy NeuroBeat without AGPL obligations; see [`LICENSING.md`](LICENSING.md)
for details and how to obtain one. Copyright (C) 2026 Talch87.
